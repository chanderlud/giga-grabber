...
pub(crate) struct Circular<'a, Theme>
where
    Theme: StyleSheet,
{
    size: f32,
    ...
    Theme: StyleSheet,
{
    ...
    pub(crate) fn bar_height(mut self, bar_height: f32) -> Self {
        self.bar_height = bar_height;
        self
    }

    /// Sets the style variant of this [`Circular`].
    pub(crate) fn style(mut self, style: <Theme as StyleSheet>::Style) -> Self {
        self.style = style;
        self
    }

    /// Sets the easing of this [`Circular`].
    pub(crate) fn easing(mut self, easing: &'a Easing) -> Self {
        self.easing = easing;
        self
    }

    /// Sets the cycle duration of this [`Circular`].
    pub(crate) fn cycle_duration(mut self, duration: Duration) -> Self {
    ...
    pub(crate) fn rotation_duration(mut self, duration: Duration) -> Self {
